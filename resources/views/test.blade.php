    ...
    document.querySelectorAll('.typed').forEach(function (el) {
        new Typed(el, {
            ...
            cursorChar: '|'
                    ...
                    {{-- uay maray pass es main total-project complete: or us k shat years of experience hain. or happy
                    client
                    hain. --}}
                    ...
                    <div class="social-links" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <a href="https://www.linkedin.com/in/shaharyarkhan4511/" target="_blank"
            ...
            <div class="col-lg-5" data-aos="fade-right" data-aos-delay="200">
                <div class="profile-image-wrapper">
                    <div class="profile-image">
                        <img src="{{ asset('assets/img/profile/profile-square-1.webp') }}" alt="Profile"
                            class="img-fluid">
                    </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-profile">
                                        <img src="{{ asset('assets/img/person/person-f-1.webp') }}" alt="Reviewer"
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-profile">
                                        <img src="{{ asset('assets/img/person/person-m-2.webp') }}" alt="Reviewer"
                                            class="img-fluid rounded-circle">
                                        <div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-profile">
                                        <img src="{{ asset('assets/img/person/person-f-3.webp') }}" alt="Reviewer"
                                            class="img-fluid rounded-circle">
                                        <div>
                                            <h3>Emily Davis</h3>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-profile">
                                        <img src="{{ asset('assets/img/person/person-m-4.webp') }}" alt="Reviewer"
                                            class="img-fluid rounded-circle">
                                        <div>
                                            <h3>Robert Wilson</h3>
