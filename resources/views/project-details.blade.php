...
@section('title', 'Portfolio Details - Shahar Yar')
...
@section('content')
            ...
            <div class="portfolio-details-media">
                ...
                <div class="portfolio-details-slider swiper init-swiper" data-aos="zoom-in">
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                     <img src="{{ asset('assets/img/portfolio/portfolio-5.webp') }}" alt="Portfolio Image" class="img-fluid">
                    ...
                    <div class="swiper-slide">
                      <img src="{{ asset('assets/img/portfolio/portfolio-8.webp') }}" alt="Portfolio Image" class="img-fluid">
                    </div>
                  </div>
              ...
              <div class="thumbnail-grid" data-aos="fade-up" data-aos-delay="200">
                <div class="row g-2 mt-3">
                  <div class="col-3">
                    <img src="{{ asset('assets/img/portfolio/portfolio-4.webp') }}" alt="Gallery Image" class="img-fluid glightbox">
                  </div>
                  <div class="col-3">
                    <img src="{{ asset('assets/img/portfolio/portfolio-6.webp') }}" alt="Gallery Image" class="img-fluid glightbox">
                  </div>
                  <div class="col-3">
                    <img src="{{ asset('assets/img/portfolio/portfolio-11.webp') }}" alt="Gallery Image" class="img-fluid glightbox">
                  </div>
                  <div class="col-3">
                    <img src="{{ asset('assets/img/portfolio/portfolio-12.webp') }}" alt="Gallery Image" class="img-fluid glightbox">
                  </div>
                </div>
              </div>
                ...
                <div class="accordion project-accordion" id="portfolio-details-projectAccordion">
                  <div class="accordion-item" data-aos="fade-up">
                    ...
                    <div id="portfolio-details-collapse-1" class="accordion-collapse collapse show"
                      ...
                      <div class="accordion-body">
                        <p>Cras ultricies ligula sed magna dictum porta. Nulla quis lorem ut libero malesuada feugiat.
                          Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Pellentesque in ipsum id
                          orci porta dapibus. Vestibulum ac diam sit amet quam vehicula elementum sed sit amet dui.</p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div id="portfolio-details-collapse-2" class="accordion-collapse collapse"
                      ...
                      <div class="accordion-body">
                        <p>Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Vivamus suscipit tortor eget
                          felis porttitor volutpat. Curabitur aliquet quam id dui posuere blandit. Praesent sapien
                          massa, convallis a pellentesque nec, egestas non nisi. Sed porttitor lectus nibh.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div id="portfolio-details-collapse-3" class="accordion-collapse collapse"
                      data-bs-parent="#portfolio-details-projectAccordion">
                      <div class="accordion-body">
                        <p>Donec sollicitudin molestie malesuada. Curabitur arcu erat, accumsan id imperdiet et,
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6" data-aos="fade-left">
            <div class="portfolio-details-content">
              <div class="project-meta">
                <div class="badge-wrapper">
                  <span class="project-badge">UX/UI Design shari</span>
                </div>
                <div class="date-client">
                  <div class="meta-item">
                    <i class="bi bi-calendar-check"></i>
    ...
    <!-- /Portfolio Details Section -->
    <section id="Urban_Architecture" class="portfolio-details section" style="display:none;">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6" data-aos="fade-left">
            <div class="portfolio-details-content">
              ...
              <div class="project-overview">
                <p class="lead">
                  mr Sharit, consectetur adipiscing elit. Maecenas varius tortor nibh, sit amet tempor nibh finibus et.
